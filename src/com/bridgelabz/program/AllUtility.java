...
*/
	/*
	 * public static int[] anagramPrime(int arr[]) { int primeAnagram[] = new
	 * int[arr.length]; int counter = 0; for (int j = 0; j < arr.length; j++) { for
	 * (int j2 = j + 1; j2 < arr.length; j2++) {
	 * 
	 * if (Utility.isAnagram(arr[j], arr[j2]) == true) { primeAnagram[counter] =
	 * arr[j]; counter++; primeAnagram[counter] = arr[j2]; counter++;
	 * 
	 * }
	 * 
	 * }
